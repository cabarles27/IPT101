...
GO
/*
The type for column Price in table [dbo].[POS] is currently  NVARCHAR (10) NULL but is being changed to  INT NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  INT NULL.

The type for column TotalAmount in table [dbo].[POS] is currently  NVARCHAR (10) NULL but is being changed to  INT NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  INT NULL.
*/
...
GO
ALTER TABLE [dbo].[POS] ALTER COLUMN [Price] INT NULL;

ALTER TABLE [dbo].[POS] ALTER COLUMN [TotalAmount] INT NULL;
...
AS
	...
	END
GO
PRINT N'Refreshing Procedure [dbo].[DeletePOS]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[DeletePOS]';
...
GO
PRINT N'Refreshing Procedure [dbo].[GetPOS]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetPOS]';
